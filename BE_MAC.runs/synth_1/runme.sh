...
HD_PWD='/home/deladrie/Bureau/BE_MAC/BE_MAC.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log EthernetController.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source EthernetController.tcl
